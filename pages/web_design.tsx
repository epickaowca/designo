...
export default function Home() {
  ...
  return (
      <DesignPageGenerator projectsArr={friendlyArr} title='web design' designCase='web' heroSection={{header: 'Web Design', paragraf: 'We build websites that serve as powerful marketing tools and bring memorable brand experiences.'}}  />
  )
}
